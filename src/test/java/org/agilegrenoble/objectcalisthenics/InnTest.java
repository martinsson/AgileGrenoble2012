...
public class InnTest {
    ...
    backstage_pass() throws Exception {
        List<Item> listOfPasses = asList(
                ...
                makeBackstagePass(quality(), sellIn()), 
                makeBackstagePass(quality(), sellIn()) );
        listOfPasses = new ArrayList<Item>();
        for (int i = 0; i < 100; i++) {
        ...
        assertThat(qualities).containsOnly(50, 27, 0, 26, 42, 50, 0, 50, 50, 0, 29, 0, 0, 36, 50, 41, 50, 0, 49, 25, 0, 12, 0, 50, 0, 0, 0, 43, 0, 50, 23, 27, 33, 0, 0, 37, 0, 43, 0, 0, 45, 50, 22, 43, 0, 30, 14, 44, 50, 0, 17, 0, 17, 50, 16, 50, 19, 44, 0, 0, 37, 34, 0, 0, 0, 50, 0, 29, 40, 50, 50, 47, 0, 0, 47, 0, 26, 11, 26, 16, 0, 50, 0, 0, 0, 35, 0, 50, 0, 40, 24, 16, 31, 50, 28, 11, 50, 0, 22, 49);
        Iterable<Integer> sellIns = extractProperty("sellIn", Integer.class).from(inn.getItems());
